    ...
    return (
        <div>
            <section className=' flex justify-between px-[53px] items-center py-2'>
                <div>
                    <p className='text-[53px]'>My Application</p>
            ...
            <div className='my-4 mx-2'>
                ...
                <div className='gap-y-6 mt-4'>
                    ...
                    <div className={`${!user.Doc_3_PC && 'hidden'}`}>
                        ...
                        <div className='max-w-[50%] mx-auto rounded-md h-[800px] border-[4px] border-[#e8c556]'><img className='' src={user.Doc_3_PC && user.Doc_3_PC} alt="Please Wait Few Moment" /></div>
                    </div>
...
export default Application_Stts;