    ...
    return (
        <div>
            <section className=' flex justify-between px-[53px] items-center py-2'>
                <div>
                    <p className='text-[53px]'>Visa certificate</p>
                    <p className='text-[23px]'>What you need to apply and manage your application, including the IRCC secure account, application status, <br /> forms and guides, offices, fees, medical exams and police checks.</p>
                </div>
                <div><img className='w-[744px] h-[220px]' src="https://www.canada.ca/content/dam/canada/employment-social-development/migration/images/assets/portfolio/images/sujet-topic/training.jpg" alt="" /></div>
            </section>
            ...
            <div className='my-4 mx-2'>
                ...
                <div className='gap-y-6 mt-4'>
                    ...
                    <div className={`${!user.Doc_2_PC && 'hidden'}`}>
                        ...
                        <div className='max-w-[50%] mx-auto rounded-md h-[800px] border-[4px] border-[#e8c556]'><img className='' src={user.Doc_2_PC && user.Doc_2_PC} alt="Please Wait Few Moment" /></div>
                    </div>
